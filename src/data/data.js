export const data = [
    ...
    {
      id: 13,
      name: 'Ravioli de Camarão com Requeijão',
      category: 'italiana',
      image:
    ...
    {
      id: 14,
      name: 'Penne à Bolognesa e Bacon',
      category: 'italiana',
      image:
    ...
    {
      id: 15,
      name: 'Gnocchi de Batata a Bolognesa',
      category: 'italiana',
      image:
    ...
    {
      id: 18,
      name: 'Combo 18 Hot Roll Philadelphia',
      category: 'japonesa',
      image:
    ...
    {
      id: 19,
      name: '12 Sashimi OU Sushi (NIGUIRI)',
      category: 'japonesa',
      image:
  ...
  export const categories = [
    {
      ...
      name: 'Lanches',
      image:
        'https://static.ifood-static.com.br/image/upload/t_medium/discoveries/lanches_HC15.png?imwidth=128',
    },
    {
      id: 2,
      name: 'Pizzas',
      image:
        'https://static.ifood-static.com.br/image/upload/t_medium/discoveries/pizzas_KxCO.png?imwidth=128',
    },
    {
      id: 3,
      name: 'Japonesa',
      image:
        'https://static.ifood-static.com.br/image/upload/t_medium/discoveries/japonesa_FP14.png?imwidth=128',
    },
  ];
